...
while(1):
    ...
    # if(b1 == True):
    #     barbarian1.move(village1, townhall1, hut1, hut2, hut3, hut4, hut5, cannon1, cannon2, wall1)
    # if(b2 == True):
    #     barbarian2.move(village1, townhall1, hut1, hut2, hut3, hut4, hut5, cannon1, cannon2, wall1)
    # if(b3 == True):
    #     barbarian3.move(village1, townhall1, hut1, hut2, hut3, hut4, hut5, cannon1, cannon2, wall1)
    os.system('clear')
